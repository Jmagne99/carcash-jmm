...
function memberCard(m) {
  const metrics = local.metrics.get(m.id) || { active_opps: 0, pipeline_value: 0, won_count: 0, won_amount: 0, conversion: 0, margin_total: 0 };
...
const styles = `
  ...
  .mc-stat { background: var(--cc-bg); padding: 10px 8px; text-align: center; }
  .mc-stat-value { font-family: var(--cc-font-mono); font-weight: 600; font-size: 14px; }
